...
**Source of truth for the downstream Agentic Coding Swarm.** Derived from `docs/PRD.md` (v2) and `docs/architecture.md` (v2). Every story is TDD-contract-bound, NFR-threshold-cited, layer-classified, dependency-wired, and regression-gated.
...
| `epics-and-stories.md` | 12 Epics / 59 Stories with hardened SDD schema + Wiring blocks. | 6 — per-story pickup |
...
- **Epics:** 12.
- **Stories:** 59 (pass 1: 30 → +4 bootstrap; pass 3: +11 completeness + 9 expansions; pass 4: +4 regression harness; **post-pass-4: +1 dev-env scripts story 0.7**).
